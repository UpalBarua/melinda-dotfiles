...
hue=(-level "0%,100%,1")
effect=(-filter Gaussian -resize 20% -define "filter:sigma=1" -resize 500.5%)
...
if [[ $color -gt $value ]]; then #white background image and black text
    bw="black"
    icon="/home/$USER/.local/share/bin/i3lock-fancy/circlelockdark.png"
    ...
    bw="white"
    icon="/home/$USER/.local/share/bin/i3lock-fancy/circlelock.png"
